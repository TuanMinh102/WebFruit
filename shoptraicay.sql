...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 17, 2024 lúc 10:08 AM
...
(1, 'album3.jpg', NULL, 'Hình ảnh Slider 1', NULL, 'slider'),
(2, 'slider1.jpg', NULL, 'Hình ảnh Slider 4', NULL, 'slider'),
(3, 'album2.jpg', NULL, 'Hình ảnh slider 2', NULL, 'slider'),
(4, 'album1.jpg', NULL, 'Hình ảnh slider 3', NULL, 'slider'),
(6, 'logo2.jpg', NULL, NULL, NULL, 'logo'),
(7, 'banner.jpg', NULL, NULL, NULL, 'banner'),
(8, 'slider3.jpg', NULL, 'Hình ảnh Slider 6', NULL, 'slider');
...
(1, 1, 0, 180, '2024-01-05', '2024-01-20'),
(2, 5, 50, 60, '2024-01-06', '2024-01-16'),
(3, 4, 0, 90, '2024-01-16', '2024-01-25'),
(4, 6, 8, 110, '2024-01-08', '2024-01-30'),
(5, 10, 1, 118, '2024-01-17', '2024-01-27'),
(6, 9, 0, 160, '2024-01-31', '2024-02-01');
...
(1, 1, 1, 180, 180, 'tuan minh', 'tuanww012@gmail.com', 'ok'),
(1, 4, 3, 80, 240, 'tuan minh', 'tuanww012@gmail.com', 'ok'),
(1, 2, 2, 200, 400, 'tuan minh', 'tuanww012@gmail.com', 'ok'),
(2, 4, 1, 80, 80, 'tuanpro ttt', 'tuanww012@gmail.com', 'ok'),
(2, 8, 1, 25, 25, 'tuanpro ttt', 'tuanww012@gmail.com', 'ok'),
(2, 6, 1, 120, 120, 'tuanpro ttt', 'tuanww012@gmail.com', 'ok'),
(3, 7, 1, 20, 20, 'tuanpro nguyen', 'tuanww012@gmail.com', 'kkk'),
(4, 8, 2, 25, 50, 'day la  tuan', 'tuanww012@gmail.com', '..'),
(5, 4, 1, 90, 90, 'tuan nguyen', 'tuanww012@gmail.com', ''),
(6, 5, 3, 120, 360, 'day la  tuan', 'tuanww012@gmail.com', ''),
(6, 7, 2, 20, 40, 'day la  tuan', 'tuanww012@gmail.com', ''),
(6, 1, 1, 180, 180, 'day la  tuan', 'tuanww012@gmail.com', '');
...
INSERT INTO `giohang` (`MaGioHang`, `MaTaiKhoan`, `MaSanPham`, `SoLuong`, `NgayTao`) VALUES
(1, 2, 5, 3, '2024-01-15 20:00:10'),
(2, 2, 10, 3, '2024-01-15 21:46:08');
...
(1, 'Giỏ quà', NULL, '2024-01-06', 300, 11, 1, '7-01.jpg', 1),
(2, 'Giỏ quà tưng bừng', NULL, '2024-01-07', 123, 10, 1, '4-08.jpg', 2),
(3, 'Khay Ngũ Quả Cúng', NULL, '2024-01-15', 366, 40, 1, '6-01.png', 2),
(4, 'Khay quả tỏ lòng', NULL, '2024-01-15', 399, 40, 1, '3-04.png', 2),
(5, 'Khay Trái Cây Gửi Yêu Thương', NULL, '2024-01-15', 66, 77, 1, '2-10-2.png', 4),
(6, 'Giỏ Trái Cây Tri Ân', NULL, '2024-01-15', 55, 77, 1, '3-13.png', 4);
...
(2, 1, '2024-01-10', '2024-01-10', 10),
(2, 3, '2024-01-10', '2024-01-10', 10),
(1, 4, '2024-01-15', '2024-01-15', 2),
(1, 7, '2024-01-15', '2024-01-15', 4),
(3, 1, '2024-01-15', '2024-01-15', 5),
(3, 5, '2024-01-15', '2024-01-15', 7),
(3, 3, '2024-01-15', '2024-01-15', 4),
(4, 3, '2024-01-15', '2024-01-15', 5),
(4, 4, '2024-01-15', '2024-01-15', 5),
(5, 1, '2024-01-15', '2024-01-15', 7),
(6, 1, '2024-01-15', '2024-01-15', 7);
...
INSERT INTO `hoadon` (`MaHD`, `MaTaiKhoan`, `NgayLapHD`, `DiaChiGiaoHang`, `Phone`, `TinhTrang`, `DanhGia`, `ThanhTien`, `PhuongThucTT`) VALUES
(1, 2, '2024-01-14', 'ho van long, quan binh tan', '0123456789', 'Đơn hàng hủy', 'true', 820, 'Ví điện tử paypal'),
(2, 2, '2024-01-15', 'ho van long, quan binh tan', '0123456789', 'Hoàn thành', 'false', 225, 'Ví điện tử paypal'),
(3, 2, '2024-01-15', 'huynh thuc khang q1', '0123456789', 'Đang xử lý', 'true', 20, 'Tiền mặt'),
(4, 2, '2024-01-15', 'huynh thuc khang q1', '0123456789', 'Đang xử lý', 'true', 50, 'Tiền mặt'),
(5, 1, '2024-01-16', 'ho van long, quan binh tan', '0123456789', 'Đang xử lý', 'true', 90, 'Tiền mặt'),
(6, 1, '2024-01-16', 'huynh thuc khang q1', '0123456789', 'Đang xử lý', 'true', 580, 'Ví điện tử paypal');
...
(1, 'Giỏ quà sinh nhật', NULL),
(2, 'Giỏ quà viếng thăm', NULL),
(3, 'Giỏ quà tri ân', NULL),
(4, 'Giỏ quà cưới hỏi', NULL),
(5, 'Giỏ quà thăm hỏi', NULL),
(6, 'Giỏ quà chia buồn', NULL);
...
(1, 'Trái cây mùa hè', NULL),
(2, 'Trái cây mùa đông', NULL),
(3, 'Trái cây mùa thu', NULL),
(4, 'Trái cây nhập khẩu', NULL),
(5, 'Trái cây khô', NULL),
(6, 'Trái cây sinh nhật', NULL);
...
(6, 'Nông sản đà lạt', 'đà lạt', '0962418040', '7777', 'dalat@gmail.com');
...
CREATE TABLE `review` (
  ...
  `ReviewIMG2` mediumtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `review` (`MaTk`, `MaSp`, `MaGQ`, `Comment`, `Rating`, `NgayThang`, `TinhTrang`, `ReviewIMG`, `ReviewIMG2`) VALUES
(2, 1, NULL, 'cam', 4, '2024-01-15 17:55:30', 'true', '1704364603_cam3.jpg', NULL),
(2, 4, NULL, 'kiwi', 2, '2024-01-15 17:55:30', 'true', NULL, '1704541072_checked.png'),
(2, 2, NULL, 'dâu', 4, '2024-01-15 17:55:30', 'true', NULL, NULL);
...
(1, 'tuan123', '25f9e794323b453885f5181f1b624d0b', 'tuanww012@gmail.com', '0123456789', 'Ho Van Long ,Binh Tan,Tp HCM', 'Nguyen Minh Tuan', 0, 'user-profile.png', 0),
(2, 'tuan2', '9990775155c3518a0d7917f7780b24aa', '0306201093@caothang.edu.vn', '0123456789', 'huynh thuc khang, quan1', 'Nguyen Minh Tuan', 0, 'avatar.png', 0),
(3, 'admin', '202cb962ac59075b964b07152d234b70', '', '', '', '', 1, 'user-profile.png', 0),
(4, 'admin2', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL, NULL, 1, 'avatar.png', 0),
(5, 'admin4', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL, NULL, 1, 'avatar.png', 0),
(6, 'admin3', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL, NULL, 1, 'avatar.png', 0);
...
INSERT INTO `traicay` (`MaTraiCay`, `TenTraiCay`, `MoTa`, `SoLuong`, `GiaGoc`, `MaNcc`, `MaLoai`, `UnitID`, `Anh`, `TinhTrang`, `NoiDung`, `LuotXem`) VALUES
(1, 'Cam', 'Được nhập từ Mỹ,...', 232, 144, 1, 1, 1, 'cam1.jpg', '1', NULL, 215),
(2, 'Dâu Tây', 'Được trồng trên Đà Lạt xa xôi', 10, 200, 4, 2, 1, 'pic2.jpg', '1', NULL, 104),
(3, 'Táo Mỹ', 'Giống táo mới được lai giống', 0, 180, 1, 1, 1, 'pic3.jpg', '0', NULL, 101),
(4, 'Kiwi xanh', 'chua chua', 50, 80, 4, 2, 1, 'pic4.jpg', '1', NULL, 121),
(5, 'Nho', '...', 79, 120, 4, 1, 1, 'pic5.jpg', '0', NULL, 22),
(6, 'Bơ Việt Nam', 'Được nhập tại Việt Nam', 0, 120, 1, 1, 1, 'pic6.jpg', '0', NULL, 46),
(7, 'Dưa hấu', 'aa', 50, 20, 1, 1, 3, 'pic7.jpg', '1', NULL, 249),
(8, 'Chuối', 'Nhiều chất vitamin', 5, 25, 5, 1, 1, 'pic8.jpg', '1', NULL, 211),
(9, 'Cherry', 'Ngon tuyệt', 15, 155, 5, 2, 1, 'pic9.jpg', '1', NULL, 7),
(10, 'Xoài Cát', 'Ngọt thanh thanh', 20, 22, 1, 2, 1, 'pic10.jpg', '1', NULL, 25);
...
--
ALTER TABLE `chatbox`
  ADD CONSTRAINT `FK_maadmin` FOREIGN KEY (`MaAdmin`) REFERENCES `taikhoan` (`MaTaiKhoan`),
...
--
-- Các ràng buộc cho bảng `gioqua`
--
ALTER TABLE `gioqua`
  ADD CONSTRAINT `FK_maloaigq` FOREIGN KEY (`MaLoaiGQ`) REFERENCES `loaigioqua` (`MaLoai`);
