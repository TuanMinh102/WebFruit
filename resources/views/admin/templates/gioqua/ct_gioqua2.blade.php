        ...
        <form id="updategioquaForm" action="{{ route('update.data.gioqua') }}" method="POST"
            ...
            <div class="container-input mt-3">
                <div class="item-input">
                    ...
                    <img id="selectedImage" alt="Selected Image" src="/images/gioqua/{{$row->Anh}}"
            ...
            <div class="container-input mt-3">
                <div class=" item-input">
                    ...
                    <input type="file" name="images[]" onchange="displaySelectedImage2(event)" id="imageInput2"
                        multiple>
                </div>
            </div>
            ...
            <div id="data_input_GQ" class="grid-4 mt-3">
                ...
                <div class="input_gioqua mb-3" id="form_{{$row->MaTraiCay}}">
                    <input type="hidden" id="traiCay{{$row->MaTraiCay}}" name="traiCay[{{$row->MaTraiCay}}][id]"
                        value="{{$row->MaTraiCay}}">
                    <label for="traiCay{{$row->MaTraiCay}}">{{$row->TenTraiCay}}</label>
                    <div class="flex align-items-center">
                        <input class="d-block" type="number" min=1 name="traiCay[{{$row->MaTraiCay}}][quantity]"
                            value="{{$row->quantity}}" placeholder="Số lượng">
                        <div class="delete-form2 ml-2" data-formid="{{$row->MaTraiCay}}"><i
