<div class="container mt-3 mb-3">
    ...
    <div class="container mb-3 mt-3">
        <form id="upadtebaivietForm" action="{{ route('update.data.baiviet') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container-input grid-3 padding-20">
                <div class="item-input">
                    <img src="/images/baiviet/{{$row->Anh}}" style="width: 200px; height: 200px; object-fit: cover;" alt="" required>
                </div>
            </div>
            <div class="">
