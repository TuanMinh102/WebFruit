<div class="container">
    ...
    <div class="container">
        <form id="updatebvForm" action="{{ route('update.data.sanpham') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                <img src="/images/sanpham/{{$row->Anh}}" style="width: 150px; height: 150px; object-fit: cover;" alt="">
            </div>
            <div class="container-input grid-3 padding-20">
                <div class="item-input">
                    <span>Chiều rộng hình ảnh:</span>
                    <input type='text' name="with" min="1" required>
                </div>
                <div class="item-input">
                    <span>Chiều dài hình ảnh:</span>
                    <input type='text' name="hight" min="1" required>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="container-input grid-3 padding-20 mt-5">
                ...
                <div class="item-input">
                    ...
                    <select name="donvi">
                        ...
                        <option value="{{$row3->MaDonVi}}">{{$row3->TenDonVi}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="item-input">
                    ...
                    <select name="nhacungcap" id="nhacungcap">
                        ...
                        <option value="{{$row4->MaNcc}}">{{$row4->TenNcc}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="item-input">
                    ...
                    <select name="loai" id="loaitraicay">
                        ...
                        <option value="{{$row2->MaLoai}}">{{$row2->TenLoai}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="item-input">
