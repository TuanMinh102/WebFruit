...
<body>
    ...
    <div class="mess">
        ...
        <div class="alert alert-success">
            <?php echo session()->get('mess-true'); session()->forget('mess-true');?>
    ...
    <div id="container-cart">
        ...
        <div id="total-checkout">
            <div class="summary-table">
                ...
                <ul>
                    <li><span>Tạm Tính:</span><span class="cost"> {{$total}}.000<u>đ</u></span></li>
                    <li><span>Tổng:</span><span id="total" class="cost"> {{$total}}.000<u>đ</u></span></li>
                </ul>
                <br><br>
